    ...
    >
      <Stack gap={10}>
        <Group align="center" gap="md">
          <Avatar size={55} radius="xl" src={c.profilePicture || undefined}>
        ...
        <Stack gap={6} mt={6}>
          ...
          <Group gap={6}>
            <IconCalendar size={16} stroke={1.5} color="#5c7cfa" />
            <Text size="sm">Joined On: {formatDate(c.createdAt)}</Text>
          </Group>

          <Group gap={6}>
            <IconCalendarCheck size={16} stroke={1.5} color="#228be6" />
            <Text size="sm">Updated At: {formatDate(c.updatedAt)}</Text>
          </Group>
        </Stack>
      </Stack>
    </Card>
    ...
    <Box style={{ minHeight: '100vh', width: '100%', padding: '1rem' }}>
      <Container size="xl" px={0}>
        ...
        {isMobile ? (
          ...
          <Card radius="lg" shadow="xl" withBorder p="lg">
                    ...
                    >
                      ...
                      <Stack gap={10} style={{ flex: 1 }}>
                        ...
                        <Group align="center" gap={6} wrap="nowrap">
                          ...
                          <Text size="sm">{formatDate(c.createdAt)}</Text>
                        </Group>
